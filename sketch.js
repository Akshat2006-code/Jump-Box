...
function draw() {
  ...
  fill("Grey");
  textSize(25);
  text("Press enter to play!",650,90);
  ...
  fill("Red");
  textSize(15);
  text("When The Button 'ENTER' Is Pressed The Ball Only Goes Left!",570,160);
  ...
  drawSprites(); 
    ...
    function keyPressed() {if (keyCode === ENTER)
      { Matter.Body.applyForce(ball.body,ball.body.position,{x:-20,y:-1 }); } }
